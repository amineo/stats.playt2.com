...
export class TwoLevelPieChart extends PureComponent {
	state = {
		...
		data: [
			{ name: 'Offense', value: this.props.data.oScore },
		...
		<Content>
			...
			<div className="border-b border-teal-500 border-dotted table w-full mb-6">
				...
				<div className="text-sm px-1 table-cell w-3/12 sm:text-base md:text-lg">
					...
					<ModalStatLine
						name="Kill Streak"
						statValue={player.stats.killStreakTG}
					/>
					<ModalStatLine
						name="Avg. Speed"
						statValue={player.stats.avgSpeedAvg}
					/>
				...
				<div className="text-sm px-1 table-cell w-3/12 sm:text-base md:text-lg">
					...
					<ModalStatLine
						name="Mine Disc"
						statValue={player.stats.minePlusDiscKillTG}
					/>
					<ModalStatLine
						name="Shots Fired"
						statValue={player.stats.shotsFiredTG}
					/>
				...
				<div className="text-sm px-1 table-cell w-3/12 sm:text-base md:text-lg">
					...
					<ModalStatLine
						name="Avg. Air Time (s)"
						statValue={player.stats.airTimeAvg}
					/>
					<ModalStatLine
						name="Dist Moved (km)"
						statValue={player.stats.distMovTG}
					/>
					<ModalStatLine
						name="Survival (mins)"
						statValue={player.stats.timeTLAvg / 60}
					/>
				</div>
			</div>
